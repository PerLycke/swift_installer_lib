...
class SynergyActivity : ThemeActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pagerAdapter.setAlertIconClickListener(object : AppListFragment.AlertIconClickListener {
            override fun onAlertIconClick(appItem: AppItem) {
                ...
                val supported = if (checkVersionCompatible(this@SynergyActivity, appItem.packageName)) {
                    ...
                    val m = Html.fromHtml(
                            "<br><b>Installed app version: " +
                                    ...
                                    getAvailableOverlayVersions(
                                            this@SynergyActivity, packageInfo, appItem.packageName), Html.FROM_HTML_MODE_LEGACY)
                    val ss = getApkLink(this@SynergyActivity, m, packageInfo, appItem.packageName)
                    message = ss
    ...
    private fun updateAdapter() {
        ...
        handler.post {
            ...
            handler.post {
                checked = pagerAdapter.getCheckedCount(container.currentItem)
                apps = pagerAdapter.getCheckableCount(this@SynergyActivity,
