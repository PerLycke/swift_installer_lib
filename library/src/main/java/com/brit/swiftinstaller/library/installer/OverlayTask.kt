    ...
    private fun applyAccent() {
        ...
        file.append(
                "<color name=\"material_blue_grey_700\">#${String.format("%06x", lightAccent).substring(
                        2)}</color>\n")
        file.append("<color name=\"highlighted_text_dark\">#${ColorUtils.getAlpha(accent, 70)}</color>\n")
        file.append("<color name=\"highlighted_text_light\">#${ColorUtils.getAlpha(accent, 85)}</color>\n")
        file.append("</resources>")
