...
class OverlayTask(val mOm: OverlayManager) : Runnable {
    ...
    private fun generateManifest(path: String, targetPackage: String,
        ...
        manifest.append("android:versionCode=\"${Utils.getOverlayVersion(context, packageName)}\"\n")
        manifest.append("android:versionName=\"${Utils.getOverlayVersion(context, packageName)}\">\n")
